...
const strings = {
  fr: {
    ...
    'notify.event.new_title': 'Nouvelle ISO détectée : {name}',
    'notify.event.new_message': '{name} {version} est disponible : {url}',
  ...
  en: {
    ...
    'notify.event.new_title': 'New ISO detected: {name}',
    'notify.event.new_message': '{name} {version} is available: {url}',
